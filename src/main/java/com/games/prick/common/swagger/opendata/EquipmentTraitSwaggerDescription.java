...
public class EquipmentTraitSwaggerDescription {

    public static final String EQUIP_TRAIT_DESCRIPTION =
    ...
    public static final String EQUIP_TRAIT_RESPONSE_ERROR_CODE =
